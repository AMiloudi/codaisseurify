...
rihanna     = Artist.create!(name: "rihanna", genre: "pop", user: henk)
luis_fonsi  = Artist.create!(name: "luis_fonsi", genre: "reggaeton", user: piet)
gotye       = Artist.create!(name: "gotye", genre: "pop", user: jan)
wreckers    = Artist.create!(name: "wreckers", genre: "country", user: henk)
